...
var gamesNext=false
function preload() {
	game.load.image('Ball C', 'assets/Ball C.png');
	game.load.image('Ball B', 'assets/Ball B.png');
	game.load.image('Ball A', 'assets/Ball A.png');
};
...
function create() {
	...
	//生成3个球
	blueBall=new ball(0,0,'Ball A',true,0)
	yellowBall=new ball(0,0,'Ball C',false)
	redBall=new ball(0,0,'Ball B',true,960)
	//设置球的body不会动
